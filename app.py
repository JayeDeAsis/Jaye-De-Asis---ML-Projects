...
if section == "Home":
    ...
    st.header("About Me")
    st.write("""
        I am Jaye P. De Asis, a 3rd year college student of Carlos Hilado Memorial State University taking a course of Bachelor of Science in Information Systems.
    ...
    st.write("""
        - **Prediction**: Make predictions based on input features using a pre-trained machine learning model. This app will predict the significance of the earthquake in a two models based on the user inputs.
        - **Sentiment Analysis**: Analyze the sentiment of a given text using a pre-trained sentiment analysis model. This app will help the user to identify their sentiment based on the sentence they will input.
        - **Image Classification**: Classify images into different categories using a pre-trained image classification model. This app will categorize what breed of dog you have when you upload the image of it on the app.
    """)
    st.header("What I Have Learned in Class")
    st.write("""
        In class, I have learned various machine learning techniques and tools, including data preprocessing, model training, evaluation, and deployment using Streamlit.
        On the early part of the course, many activities I tried to delv in just to know how to manipulate data, refine data, analyzing data, and training models.
        I have also gained hands-on experience in developing end-to-end machine learning applications to solve real-world problems.
    """)
